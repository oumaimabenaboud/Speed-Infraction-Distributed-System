...
public final class RadarGrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.sid.stub.RadarService.InfractionRequest,
      org.sid.stub.RadarService.Infraction> getGenerateInfractionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "generateInfraction",
      requestType = org.sid.stub.RadarService.InfractionRequest.class,
      responseType = org.sid.stub.RadarService.Infraction.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.sid.stub.RadarService.InfractionRequest,
      org.sid.stub.RadarService.Infraction> getGenerateInfractionMethod() {
    io.grpc.MethodDescriptor<org.sid.stub.RadarService.InfractionRequest, org.sid.stub.RadarService.Infraction> getGenerateInfractionMethod;
      ...
      synchronized (RadarGrpcServiceGrpc.class) {
        if ((getGenerateInfractionMethod = RadarGrpcServiceGrpc.getGenerateInfractionMethod) == null) {
          RadarGrpcServiceGrpc.getGenerateInfractionMethod = getGenerateInfractionMethod = 
              io.grpc.MethodDescriptor.<org.sid.stub.RadarService.InfractionRequest, org.sid.stub.RadarService.Infraction>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "RadarGrpcService", "generateInfraction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.sid.stub.RadarService.InfractionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.sid.stub.RadarService.Infraction.getDefaultInstance()))
  ...
  public static abstract class RadarGrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void generateInfraction(org.sid.stub.RadarService.InfractionRequest request,
        io.grpc.stub.StreamObserver<org.sid.stub.RadarService.Infraction> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.sid.stub.RadarService.InfractionRequest,
                org.sid.stub.RadarService.Infraction>(
  ...
  public static final class RadarGrpcServiceBlockingStub extends io.grpc.stub.AbstractStub<RadarGrpcServiceBlockingStub> {
    ...
    /**
     */
    public org.sid.stub.RadarService.Infraction generateInfraction(org.sid.stub.RadarService.InfractionRequest request) {
  ...
  public static final class RadarGrpcServiceFutureStub extends io.grpc.stub.AbstractStub<RadarGrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.sid.stub.RadarService.Infraction> generateInfraction(
        org.sid.stub.RadarService.InfractionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GENERATE_INFRACTION:
          serviceImpl.generateInfraction((org.sid.stub.RadarService.InfractionRequest) request,
              (io.grpc.stub.StreamObserver<org.sid.stub.RadarService.Infraction>) responseObserver);
          break;
        default:
  ...
  private static abstract class RadarGrpcServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.sid.stub.RadarService.getDescriptor();
    }
